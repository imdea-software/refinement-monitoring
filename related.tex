...
conf/cav/AmitRRSY07, DBLP:conf/cav/DragoiGH13, conf/fm/LiuCLS09,
...
% points is described in~\cite{DBLP:conf/issta/ShachamYGABSV14} where verifying
...
violations~\cite{conf/pldi/BurckhardtDMT10, DBLP:conf/asplos/BurnimNS11,
DBLP:conf/kbse/ZhangCW13, DBLP:journals/jpdc/WingG93} enumerate the
