...
\begin{tikzpicture}[node distance=4mm]
  ...
  % dotted barrier
  \node[nnode] (b1)  [right = 0mm of x2,yshift = 5mm,xshift=-9mm] {};
  \node[nnode] (b2)  [right=  0mm of x2,yshift = -25mm,xshift=-9mm] {}; 
  ...
  % dotted barrier
  \node[nnode] (bb1)  [right = 32mm of b1] {};
  \node[nnode] (bb2)  [right=  32mm of b2] {}; 
