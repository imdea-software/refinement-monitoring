...
i.e., for every $o_1,o_2\in O$ there exists an unique $o'\in O$ such that $\<Matching>(o,o')$.
...
The operations occurring as the first, resp., second, argument of a matching relation are called negative, resp., positive.
...
$\tup{e,\<Matching>}$ and $\tup{e,\<Matching>}$ of $L$, $e$ is different from $e'$.
