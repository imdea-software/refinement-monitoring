...
%  \item{Negative Labels:} $\set{\<dequeue> \Rightarrow x\ |\ x \in \domain}$
%  \end{itemize}
%
%\item{Stack}
%  \begin{itemize}
%  \item{Positive Labels:} $\set{\<push>(x)\ |\ x \in \domain}$
%  \item{Negative Labels:} $\set{\<pop> \Rightarrow x\ |\ x \in \domain}$
%  \end{itemize}
%
%\item{Register}
%  \begin{itemize}
%  \item{Positive Labels:} $\set{\<write>(x)\ |\ x \in \domain}$
%  \item{Negative Labels:} $\set{\<read> \Rightarrow x\ |\ x \in \domain}$
%  \end{itemize}
%
%\item{PriorityQueue}
%  \begin{itemize}
%  \item{Positive Labels:} $\set{\<add>(x)\ |\ x \in \domain}$
%  \item{Negative Labels:} $\set{\<removeMax> \Rightarrow x\ |\ x \in \domain}$
%  \end{itemize}
%  
%\item{Set}
...
%  \item{Negative Labels:} $\<remove>$ and $\<contains> \Rightarrow \top$
%  \end{itemize}
%  
%\item{Lock}
%  \begin{itemize}
...
%  injection $g: O_2 \to O_1$ such that
%  \begin{itemize}
%
...
%
%  \end{itemize}
%  where $(m_1(u_1) \Rightarrow v_1) \ll (m_2(u_2) \Rightarrow v_2)$ if{f} $m_1 = m_2$, $u_1 =
