...
\metalangkeyword{push,pop,PO,Dom,null,hb,Injective,set,b,ContainsTrue,ContainsFalse,ops,Distinct}
\metalangkeyword{read,write,mset}
\metalangkeyword{enqueue,dequeue,Match(reg),Read,ReadFrom,Register,Match,Total,NoSuccLocks,TooManyAcq}
\metalangkeyword{add,remove,contains,rem,lb,match,hb,meth,arg,ret,empty,Sequential,Match(set),Empty,Fifo,Lifo,Max,Queues,Stacks,Priority,Multiset,Empty,Remove,IsContained,IsNotContained,Set}
\metalangkeyword{lock,unlock,Lock,Semaphore,Exchanger}
