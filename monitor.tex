...
Thus, a history $h$ belongs to $H(L)$ iff 
...
Thus, given a complete history $h=\tup{O,<,f}$, let $\mathit{Hist}(h)$ be a history formula 
...
is equi-satisfiable to $\mathit{Hist}(h)\land\mathit{Weaker}\land \psi$.
