...
\subsection{Monitoring complete histories}\label{ssec:complete}
...
\subsection{Monitoring histories with pending operations}\label{ssec:pending}
...
\caption{Removing the matching cluster $\{{\tt push}(2),{\tt pop}=>2\}$ with complete but not obsolete operations.}
