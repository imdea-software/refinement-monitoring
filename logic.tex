...
%partial function $M_h : O /-> O$ over its operations. Intuitively, $M_h$ 
maps
...
%    & \textsc{UniqRem} \\
%      & \forall r_1, r_2.\
%        {\sf meth}(r_1) = {\sf meth}(r_2) = {\sf rem} \land
%        {\sf ret}(r_1) = {\sf ret}(r_2) \implies r_1 = r_2
%    \\
    & \textsc{AddRem} \\
...
%\begin{align*}
%\exists r,c.\ &
%  {\sf remove}(r) \land {\sf contains}(c) \land \rval{c} = {\sf true}
%  \land r \poker c \land\\
%    &\forall a.\ r \poker a \land a \poker c \implies 
%      \neg \<Matching>(c,a)
%\end{align*}
%
...
%\begin{align*}
%\exists a,c.\ &
%  {\sf add}(a) \land \containsfalse(c)
%  \land a \poker c \land\\
%   & \forall r.\ (a \poker r \land r \poker c \land {\sf remove}(r))
%    \implies \\
%    &\qquad \neg \<Matching>(r,a)
%\end{align*}
...
\begin{figure}
  ...
  \begin{align*}
    ...
    & \quad \land {\sf meth}(r) = {\sf remove}\land {\sf meth}(a) = {\sf add} \land  {\sf match}(c,a) \land {\sf match}(r,a)  \\ %{\sf arg}(c) = {\sf arg}(r) = {\sf arg}(a) \\
