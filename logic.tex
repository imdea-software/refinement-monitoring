...
\<Lock> & \triangleq \<Sequential>\land \<Match>_3(\<unlock>,\<lock>)\land \<Injective> \land\forall x_l,x_l'.\ (\<meth>(x_l)=\<lock>\land \<meth>(x_l')=\<lock>\land \<b>(x_l,x_l'))\\
&\hspace{9cm}=> \exists y.\ \<b>(x_l,y)\land \<b>(y,x_l') \\[2mm]
\<Semaphore> & \triangleq \<Sequential>\land \<Match>_3(\<release>,\<acquire>)\land \<Injective>\land \forall x_0,\dots,x_\capacity.\ 
